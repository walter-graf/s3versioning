...
# by Walter Graf
#
# usage: s3setv.py [-h] [-c s3-config-file] bucket-name
#
# set versioning for existing bucket
#
...
parser = argparse.ArgumentParser(description = "set versioning for existing bucket")
...
# set versioning in existing bucket
